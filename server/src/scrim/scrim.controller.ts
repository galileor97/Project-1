...
@swagger.ApiTags("scrims")
@common.Controller("scrims")
export class ScrimController {
  ...
  @swagger.ApiCreatedResponse({ type: Scrim })
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async create(
    @common.Query() query: {},
    @common.Body() data: ScrimCreateInput,
  ...
  @swagger.ApiOkResponse({ type: [Scrim] })
  @swagger.ApiForbiddenResponse()
  async findMany(
    @common.Query() query: ScrimWhereInput,
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<Scrim[]> {
    const permission = this.rolesBuilder.permission({
      role: userRoles,
  ...
  async findOne(
    @common.Query() query: {},
    @common.Param() params: ScrimWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<Scrim | null> {
    const permission = this.rolesBuilder.permission({
      role: userRoles,
